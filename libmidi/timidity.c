...
MidSong *mid_song_load_dls(streamBuffer *stream, MidDLSPatches *patches, MidSongOptions *options)
{
  MidSong *song;
  int i;
...
MidSong *mid_song_load(streamBuffer *stream, MidSongOptions *options)
{
