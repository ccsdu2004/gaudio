...
{
    printf("autowah created by D.Eric\n");
    ...
    geffect* effect = gaudio_effect_create(AUDIO_EFFECT_TREMOLO,0);
    if(!effect)
    {
        printf("not support tremolo effect\n");
