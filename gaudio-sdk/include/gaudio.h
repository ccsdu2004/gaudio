...
enum gplugin_code
{
    ...
    AUDIO_PLUGIN_CACHER,   /**< the audio recoder plugin of GAUdio SDK. */
    AUDIO_PLUGIN_WRITER
};
...
typedef struct gwriter_  gwriter;

/*************************************************************************
 * GAudio API functions
 *************************************************************************/

extern GAPI void GAPIENTRY gaudio_config(const char*);
 ...
 *  @ingroup init
 */
extern GAPI void GAPIENTRY gaudio_init(const char*);
...
#define AUDIO_EFFECT_FILTER_LOWPASS         0
#define AUDIO_EFFECT_FILTER_HIGHPASS        1
#define AUDIO_EFFECT_FILTER_BANDPASS        2
#define AUDIO_EFFECT_FILTER_ALLPASS         3
#define AUDIO_EFFECT_FILTER_BIQUADPASS      4
#define AUDIO_EFFECT_FILTER_TREBLE          5
#define AUDIO_EFFECT_FILTER_NOTCH           6
#define AUDIO_EFFECT_FILTER_PEAKING_BANDEQ  7
#define AUDIO_EFFECT_FILTER_LOW_SHELF       8
#define AUDIO_EFFECT_FILTER_HIGH_SHELF      9
#define AUDIO_EFFECT_PHASER                 16
#define AUDIO_EFFECT_INVERT                 17
#define AUDIO_EFFECT_SWAP_CHANNEL           18
#define AUDIO_EFFECT_MERGE_CHANNEL          19
#define AUDIO_EFFECT_SPEED_CHANGER          20
#define AUDIO_EFFECT_ECHO                   21
#define AUDIO_EFFECT_REVERB                 22
#define AUDIO_EFFECT_FFT                    23
#define AUDIO_EFFECT_EQUALIZER              24
#define AUDIO_EFFECT_BASSBOOST              25
#define AUDIO_EFFECT_CHORUS                 26
#define AUDIO_EFFECT_STEREO_ENHANCE         27
#define AUDIO_EFFECT_DISTORTION             28
#define AUDIO_EFFECT_FOLDBACK_DISTORTION    29
#define AUDIO_EFFECT_FLANGER                30
#define AUDIO_EFFECT_AUTOWAH                31
#define AUDIO_EFFECT_COMPRESSER             32
#define AUDIO_EFFECT_MODULATOR              33
#define AUDIO_EFFECT_FADE_IN                34
#define AUDIO_EFFECT_FADE_OUT               35
#define AUDIO_EFFECT_TREMOLO                36
#define AUDIO_EFFECT_STEREO_WIDENING        37
...
/**Flanger effect*/
#define AUDIO_EFFECT_FLANGER_WAVEFORM 1
#define AUDIO_EFFECT_FLANGER_PHASE    2
#define AUDIO_EFFECT_FLANGER_RATE     3
#define AUDIO_EFFECT_FLANGER_DEPTH    4
#define AUDIO_EFFECT_FLANGER_FEEDBACK 4
#define AUDIO_EFFECT_FLANGER_DELAY    5

#define AUDIO_EFFECT_FLANGER_WAVEFORM_SINUSOID   0
#define AUDIO_EFFECT_FLANGER_WAVEFORM_TRIANGLE   1
#define AUDIO_EFFECT_FLANGER_DEFAULT_WAVEFORM    1

#define AUDIO_EFFECT_FLANGER_MIN_PHASE           -180.0f
#define AUDIO_EFFECT_FLANGER_MAX_PHASE           180.0f
#define AUDIO_EFFECT_FLANGER_DEFAULT_PHASE       .0f

#define AUDIO_EFFECT_FLANGER_MIN_RATE            .0f
#define AUDIO_EFFECT_FLANGER_MAX_RATE            10.0f
#define AUDIO_EFFECT_FLANGER_DEFAULT_RATE        0.27f

#define AUDIO_EFFECT_FLANGER_MIN_DEPTH                     0.0f
#define AUDIO_EFFECT_FLANGER_MAX_DEPTH                     1.0f
#define AUDIO_EFFECT_FLANGER_DEFAULT_DEPTH                 1.0f

#define AUDIO_EFFECT_FLANGER_MIN_FEEDBACK                  -1.0f
#define AUDIO_EFFECT_FLANGER_MAX_FEEDBACK                  1.0f
#define AUDIO_EFFECT_FLANGER_DEFAULT_FEEDBACK              -0.5f

#define AUDIO_EFFECT_FLANGER_MIN_DELAY                     0.0f
#define AUDIO_EFFECT_FLANGER_MAX_DELAY                     0.004f
#define AUDIO_EFFECT_FLANGER_DEFAULT_DELAY                 0.002f
...
enum gerror_code
{
    ...
    AUDIO_INVALID_OPERATION, /**< This operation is prohibited */
...
extern GAPI gwriter* GAPIENTRY gaudio_writer_create(int32_t flag,int32_t channel,int32_t samplerate,int32_t format);
extern GAPI int32_t GAPIENTRY gaudio_writer_open_file(gwriter* writer,const char* filename);
extern GAPI int32_t GAPIENTRY gaudio_writer_write(gwriter,uint8_t* data,int32_t length);
extern GAPI void GAPIENTRY gaudio_writer_close(gwriter* writer);
extern GAPI void GAPIENTRY gaudio_writer_destroy(gwriter* writer);
