...
static void GAPIENTRY wave_decoder_destroy(gdecoder* decoder)
{
    delete decoder->impl;
    decoder->impl = 0;
    delete decoder;
...
static uint32_t GAPIENTRY wave_decoder_get_int32(gdecoder* decoder,uint32_t flag)
{
...
static int32_t GAPIENTRY wave_decoder_init(gdecoder* decoder)
{
...
static int32_t GAPIENTRY wave_decoder_seek(gdecoder* decoder,uint32_t position)
{
...
static uint32_t GAPIENTRY wave_decoder_read(gdecoder* decoder,float* pcm,int32_t length)
{
    uint32_t size = 0;
...
gdecoder* gdecoder_create()
{
    ...
    decoder->meta = 0;
    decoder->destroy = wave_decoder_destroy;
    decoder->init = wave_decoder_init;
    decoder->seek = wave_decoder_seek;
    decoder->read = wave_decoder_read;
    ...
    decoder->getint = wave_decoder_get_int32;
    return decoder;
}

static gaddons addon;

gaddons* GAPIENTRY gwave_instance(void* ctx)
{
